...
import { useRequestPasswordReset } from "queries/users";
...
import type { PasswordResetRequestData } from "models";
import { ROUTES } from "routes";

const buildForgotPasswordSchema = (
  t: TFunction,
): FormSchema<PasswordResetRequestData> =>
  z.object({ email: buildEmailField(t) });
